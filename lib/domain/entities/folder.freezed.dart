...
abstract class $FolderCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String name, List<ApiRequest> requests, String description});
}
...
class _$FolderImpl implements _Folder {
  ...
  @override
  String toString() {
    return 'Folder(id: $id, name: $name, requests: $requests, description: $description)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name,
      const DeepCollectionEquality().hash(_requests), description);
...
abstract class _Folder implements Folder {
  const factory _Folder(
      ...
      final String description}) = _$FolderImpl;
