...
abstract class $EnvironmentCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, List<Variable> variables});
}
...
class _$EnvironmentImpl implements _Environment {
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, const DeepCollectionEquality().hash(_variables));
...
abstract class _Environment implements Environment {
  const factory _Environment(
      ...
      final List<Variable> variables}) = _$EnvironmentImpl;
