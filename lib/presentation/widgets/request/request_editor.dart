...
class _BodyEditor extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (tab.collectionId != null) {
      final collections = ref.watch(collectionsProvider).value ?? [];
      final col = collections.where((c) => c.id == tab.collectionId).firstOrNull;
      if (col != null) {
        if (col.environmentId != null) {
          final envs = ref.watch(environmentsProvider).value ?? [];
          final linkedEnv = envs.where((e) => e.id == col.environmentId).firstOrNull;
    ...
    return Column(
      children: [
        ...
        Expanded(child: _buildBodyContent(context, req, notifier, envVarsList, resolvedVars)),
      ],
    );
  }

  Widget _buildBodyContent(BuildContext context, ApiRequest request, notifier, List<String> envVarsList, Map<String, String> resolvedVars) {
...
class _BodyTypeBar extends ConsumerWidget {
  ...
  String _label(BodyType t) {
    switch (t) {
      ...
      case BodyType.formData: return 'form-data';
      case BodyType.urlEncoded: return 'x-www-form-urlencoded';
...
class _RawBodyEditorState extends ConsumerState<_RawBodyEditor>
  ...
  String get _language {
    switch (widget.tab.request.bodyType) {
      case BodyType.json: return 'json';
      case BodyType.raw:  return 'plaintext';
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Type', style: TextStyle(color: context.colors.textPrimary, fontWeight: FontWeight.bold, fontSize: 14)),
                ...
                children: [
                  ...
                  if (auth.type == AuthType.basic) ...[
                    _AuthField(
                      ...
                      resolvedEnvVars: resolvedVars,
                      onChanged: (v) => notifier.updateRequest(
                          tab.id, req.copyWith(auth: auth.copyWith(username: v))),
                    ),
                    ...
                    _AuthField(
                      ...
                      resolvedEnvVars: resolvedVars,
                      onChanged: (v) => notifier.updateRequest(
                          tab.id, req.copyWith(auth: auth.copyWith(password: v))),
                    ),
                  ],
                  if (auth.type == AuthType.apiKey) ...[
                    _AuthField(
                      ...
                      resolvedEnvVars: resolvedVars,
                      onChanged: (v) => notifier.updateRequest(
                          tab.id, req.copyWith(auth: auth.copyWith(apiKeyHeader: v))),
                    ),
                    const SizedBox(height: 16),
                    _AuthField(
                      label: 'Value',
                      ...
                      resolvedEnvVars: resolvedVars,
                      onChanged: (v) => notifier.updateRequest(
                          tab.id, req.copyWith(auth: auth.copyWith(apiKeyValue: v))),
                    ),
                  ],

                   if (auth.type == AuthType.oauth2)
                     _OAuth2Editor(tab: tab),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          // Flow selector
          Text('Flow', style: TextStyle(color: context.colors.textPrimary, fontWeight: FontWeight.bold, fontSize: 14)),
          const SizedBox(height: 8),
          ...
          // Token URL
          Text('Token URL', style: TextStyle(color: context.colors.textPrimary, fontWeight: FontWeight.bold, fontSize: 14)),
          const SizedBox(height: 8),
          TextField(
            style: TextStyle(color: context.colors.textPrimary, fontSize: 14),
            decoration: const InputDecoration(
          ...
          // Client ID
          Text('Client ID', style: TextStyle(color: context.colors.textPrimary, fontWeight: FontWeight.bold, fontSize: 14)),
          const SizedBox(height: 8),
          TextField(
            style: TextStyle(color: context.colors.textPrimary, fontSize: 14),
            decoration: const InputDecoration(
          ...
          // Client Secret
          Text('Client Secret', style: TextStyle(color: context.colors.textPrimary, fontWeight: FontWeight.bold, fontSize: 14)),
          const SizedBox(height: 8),
          TextField(
            style: TextStyle(color: context.colors.textPrimary, fontSize: 14),
            decoration: const InputDecoration(
          ...
          if (oauth2.flow == OAuth2Flow.authorizationCode) ...[
            ...
            const SizedBox(height: 16),
            Text('Redirect URL', style: TextStyle(color: context.colors.textPrimary, fontWeight: FontWeight.bold, fontSize: 14)),
            const SizedBox(height: 8),
            TextField(
              style: TextStyle(color: context.colors.textPrimary, fontSize: 14),
              decoration: const InputDecoration(
          ...
          if (oauth2.flow == OAuth2Flow.password) ...[
            Text('Username', style: TextStyle(color: context.colors.textPrimary, fontWeight: FontWeight.bold, fontSize: 14)),
            const SizedBox(height: 8),
            TextField(
              style: TextStyle(color: context.colors.textPrimary, fontSize: 14),
              decoration: const InputDecoration(
            ...
            const SizedBox(height: 16),
            Text('Password', style: TextStyle(color: context.colors.textPrimary, fontWeight: FontWeight.bold, fontSize: 14)),
            const SizedBox(height: 8),
            TextField(
              style: TextStyle(color: context.colors.textPrimary, fontSize: 14),
              decoration: const InputDecoration(
          ...
          // Scope
          Text('Scope (optional)', style: TextStyle(color: context.colors.textPrimary, fontWeight: FontWeight.bold, fontSize: 14)),
          const SizedBox(height: 8),
          TextField(
            style: TextStyle(color: context.colors.textPrimary, fontSize: 14),
            decoration: const InputDecoration(
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Row(
            children: [
              Icon(Icons.auto_fix_high_outlined, size: 12, color: context.colors.accent.withValues(alpha: 0.7)),
        ...
        Container(
          ...
          child: Column(
            children: autoHeaders.asMap().entries.map((itemEntry) {
              ...
              return Tooltip(
                message: 'This header is automatically computed by Mapia based on your request config (auth/body type).',
                waitDuration: const Duration(milliseconds: 500),
                child: Container(
                  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                  decoration: BoxDecoration(
                    border: isLast ? null : Border(bottom: BorderSide(color: context.colors.border, width: 0.5)),
                  ),
                  child: Row(
                    children: [
